...
//alert($admin_name);
$("#right_foot").html('<p></p>'+$admin_name);
...
//发送后调用此方法
 function saysay(){
	 ...
	 if($(".list").length<1){
	  ...
	  if($("#texterea").val()){
	  $("#user_con"+ing_user).append('<div class="my_say_con"><font color=\"#0000FF\">'+$admin_name+t+"</font><p><font color=\"#333333\">"+trim2(trim(""))+'</font></p></div>');
...
//欢迎
$("#top").html('<br />&nbsp;&nbsp;'+dandan.mytime()+',欢迎你的到来！！');
